เนื่องจากโค้ดทั้งสองส่วนเหมือนกันทุกประการ คุณสามารถลบเครื่องหมายที่ทำให้เกิด Merge Conflict ออกได้เลยครับ

นี่คือโค้ด app.py ที่แก้ไขแล้ว โดยได้ลบบรรทัดที่มีเครื่องหมาย <<<<<<< HEAD, =======, และ >>>>>>> ออกทั้งหมด:
